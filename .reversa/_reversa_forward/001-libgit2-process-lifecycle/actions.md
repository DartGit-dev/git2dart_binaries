...
|----|-----------|--------------|-------------|--------------|-------------|--------|
| E001 | Record the generated build/release-output boundary and remove the four untracked Windows runtime DLLs. | - | - | `windows/{libcrypto-3-x64.dll,libssl-3-x64.dll,libssh2.dll,libgit2.dll}` | 🟢 | [X] |
